            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="indexlogout.php" class="nav-item nav-link active">Home</a>
                        <a href="aboutlogout.php" class="nav-item nav-link">About</a>
                        <a href="productslogout.php" class="nav-item nav-link">Products</a>
                       ...
                       // <div class="nav-item dropdown">
                        ...
                        //</div>
                        ?>
                        <a href="contactlogout.php" class="nav-item nav-link">Contact</a>
                    </div>
                </div>
            </nav>
        </div>
