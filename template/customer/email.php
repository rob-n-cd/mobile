...
$mail->Username   = "georgefrancis2021@gmail.com";
$mail->Password   = "cdbnrqoctsnbukvo";
//$mail->Password   = "12333";
 $mail->IsHTML(true);
//$mail->AddAddress("rajutharayil@depaul.edu.in", "vijitha");
$name="williamgeorgemaniac@depaul.edu.in";
$mail->AddAddress($name, "Raju");
//$mail->SetFrom("rajutharayil@depaul.edu.in", "joseph");
$mail->SetFrom("georgefrancis2021@gmail.com", "joseph");
