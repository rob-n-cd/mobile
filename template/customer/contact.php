    ...
    <div class="container-fluid bg-white">
        <div class="container">
            <div class="row">
                    ...
                    <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Our Office</h4>
                                <p class="m-0 text-white">Ochanthuruth, Ernakulam, India</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Email Us</h4>
                                <p class="m-0 text-white">emmaspolymers@gmail.com</p>
                            </div>
                        </div>
               ...
               $q="INSERT into contactus (contname,contemail,contsubject,contmsg) VALUES ('$conname','$conemail','$consubject','$conmsg')";
               $conn->query($q);
